...
Here are some sources, refreshed as of Dec 2019:
...
- Saved as PNG: [[./ontotext-graphdb-applications.png]]
- Saved SVG: [[./ontotext-graphdb-applications.svg]]. Please note that this is a bit inferior. "Saving as SVG is an experimental feature. Depending on the SVG viewer you use, texts might not be aligned properly in the word cloud. Masks are not visible either."
